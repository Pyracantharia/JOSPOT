...
const stripesMobile = document.querySelectorAll("#event-toggler-mobile .stripe");
const eventsSection = document.querySelector("#events-section");
burgerMenuMobile.addEventListener("click", () => {
    stripesMobile.forEach((stripe) => stripe.classList.toggle("touch-active"));
    eventsSection.classList.toggle("translate-y-[100%]")
});

const burgerMenuDesktop = document.getElementById("burger-menu-desktop");
const stripesDesktop = document.querySelectorAll("#event-toggler-desktop .stripe");
burgerMenuDesktop.addEventListener("click", () => {
    stripesDesktop.forEach((stripe) => stripe.classList.toggle("touch-active"));
    eventsSection.classList.toggle("sm:translate-x-[-100%]")
});
